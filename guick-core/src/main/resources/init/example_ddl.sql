...
insert into orgao (sigla, nome ) values ('GERENCIA', 'Gernência');
...
ALTER TABLE historia ADD CONSTRAINT historia_id_f14aa6df_fk_id FOREIGN KEY (id) REFERENCES projeto(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE time ADD CONSTRAINT tim_id_5b489fa4_fk_ FOREIGN KEY (id) REFERENCES projeto(id) DEFERRABLE INITIALLY DEFERRED;
