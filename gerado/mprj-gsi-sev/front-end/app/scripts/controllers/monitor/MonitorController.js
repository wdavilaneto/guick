...
angular.module('sevApp').controller('HealthController', function ($scope, HealthCheckService) {
...
angular.module('sevApp').controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
    $scope.metrics = {};
