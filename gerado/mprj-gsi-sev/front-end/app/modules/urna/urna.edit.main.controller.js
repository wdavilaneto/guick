...
angular.module('sevApp')
    .controller('urnaEditMainController', urnaEditMainController);

    urnaEditMainController.$inject = ['$scope', '$state', '$stateParams', '$modal', '$location', 'jsog', 'urnaService', 'cedulaService', 'eleicaoService'];

    function urnaEditMainController($scope, $state, $stateParams , $modal, $location, jsog, urnaService , cedulaService, eleicaoService ) {
        ...
        vm.save = function () {
            ...
            console.log('Requesting save on urna');
                ...
                console.log(successResult);
                    ...
                    $state.go('urnaSearch', {}, {reload: true});
            });
        };
        ...
        vm.saveContinue = function () {
            ...
            console.log('Requesting save on urna');
                ...
                urnaService.save(vm.entity, function (successResult) {
                console.log(successResult);
                    $state.go('urnaEdit.main', {id: successResult.id}, {reload: true});
        ...
        // Create Urna Modal Window
            ...
            var modalInstance = $modal.open({
                templateUrl: 'createUrnaModal.html', controller: 'ModalUrnaController', size: size,
                resolve: {
                    data: function () {
                        return vm.entity;
                    }
        ...
        vm.remove = function (obj) {
            var modalInstance = $modal.open({
                templateUrl: 'confirmRemoveUrnaModal.html',
                controller: 'ModalUrnaController',
                size: 'lg',
                resolve: {
                    data: function () {
                        return vm.entity;
        ...
        // Inline Update Modal
            vm.editUrna = function (obj) {
            var modalInstance = $modal.open({
                templateUrl: 'createUrnaModal.html', controller: 'ModalUrnaController', size: 'lg',
                resolve: {
                    data: function () {
                        return obj;
                    },
        ...
        // ****************************************
        // if in edit mode get the wanted urna
        if ($stateParams.id) {
