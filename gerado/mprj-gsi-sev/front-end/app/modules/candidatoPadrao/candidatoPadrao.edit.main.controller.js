...
angular.module('sevApp')
    .controller('candidatoPadraoEditMainController', candidatoPadraoEditMainController);

    candidatoPadraoEditMainController.$inject = ['$scope', '$state', '$stateParams', '$modal', '$location', 'jsog', 'candidatoPadraoService', 'candidatoService'];

    function candidatoPadraoEditMainController($scope, $state, $stateParams , $modal, $location, jsog, candidatoPadraoService , candidatoService ) {
        ...
        vm.save = function () {
            ...
            console.log('Requesting save on candidatoPadrao');
                ...
                console.log(successResult);
                    ...
                    $state.go('candidatoPadraoSearch', {}, {reload: true});
            });
        };
        ...
        vm.saveContinue = function () {
            ...
            console.log('Requesting save on candidatoPadrao');
                ...
                candidatoPadraoService.save(vm.entity, function (successResult) {
                console.log(successResult);
                    $state.go('candidatoPadraoEdit.main', {id: successResult.id}, {reload: true});
        ...
        // ******************************************************************************************
        // Create CandidatoPadrao Modal Window
            vm.open = function (size) {
                vm.searchSelects.toEntity(vm.entity);
            var modalInstance = $modal.open({
                templateUrl: 'createCandidatoPadraoModal.html', controller: 'ModalCandidatoPadraoController', size: size,
                resolve: {
                    data: function () {
                        return vm.entity;
                    }
        ...
        vm.remove = function (obj) {
            var modalInstance = $modal.open({
                templateUrl: 'confirmRemoveCandidatoPadraoModal.html',
                controller: 'ModalCandidatoPadraoController',
                size: 'lg',
                resolve: {
                    data: function () {
                        return vm.entity;
        ...
        // Inline Update Modal
            vm.editCandidatoPadrao = function (obj) {
            var modalInstance = $modal.open({
                templateUrl: 'createCandidatoPadraoModal.html', controller: 'ModalCandidatoPadraoController', size: 'lg',
                resolve: {
                    data: function () {
                        return obj;
                    },
        ...
        // ****************************************
        // if in edit mode get the wanted candidatoPadrao
        if ($stateParams.id) {
