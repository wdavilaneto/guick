...
/**
 * TipoRelatorio
 * A classe TipoRelatorio representa o mapeamento Objeto-Relacional
 * da entidade de negocio armazenada na tabela SEVO_TP_RELATORIO.
 *${entity.table.comment}
 */
@Entity
@Table(name = "SEVO_TP_RELATORIO")
@SequenceGenerator(name = "SEVO_SQ_TRET_DK", sequenceName = "SEVO_SQ_TRET_DK")
//@Immutable ?
//@Cacheable
...
public class TipoRelatorio implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "SEVO_SQ_TRET_DK")
    @Column(name="TRET_DK" )
    private Long id;

    @Size(max = 50)
    @Column(name = "TRET_DS_TP_RELATORIO", length = 50)
    String descricao;

    @JsonIgnore
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "tipoRelatorio")
    ...
    public boolean equals(Object obj) {
        ...
        TipoRelatorio rhs = (TipoRelatorio) obj;
