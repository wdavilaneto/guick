...
public class EventoController {
    ...
    public HttpEntity<Page<Evento>> findAll(Pagination pagination) {
        return new ResponseEntity(eventoService.findAll(pagination.getPageable()), OK);
    }
    ...
    public HttpEntity<Page<Evento>> search(@RequestBody SearchFilter<Evento> filter) {
        return new ResponseEntity(eventoService.search(filter.getContent() , filter.getPageable()), OK);
    }
    ...
    public HttpEntity<Page<Evento>> searchTextGet(String text) {
        return new ResponseEntity(eventoService.searchText(text , DEFAULT_PAGE ), OK);
    }
    /**
     * Returns a paged and filtered list with an given example (ignoring relationship examples beyond id)
     * @param filter
    ...
    public HttpEntity<Page<Evento>> searchText(@RequestBody SearchFilter<String> filter) {
        return new ResponseEntity(eventoService.searchText(filter.getContent() , filter.getPageable()), OK);
    }
    /**
    ...
    public HttpEntity<Evento> get(@PathVariable Long id) {
        return new ResponseEntity(eventoService.findOne(id), OK);
    }
    ...
    public HttpEntity<Evento> save(@RequestBody Evento evento) {
